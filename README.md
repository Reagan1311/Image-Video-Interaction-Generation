...
- `CVPR'23` :mag_right: Affordance Diffusion: Synthesizing Hand-Object Interactions [[project]](https://judyye.github.io/affordiffusion-www/) [[code]](https://github.com/NVlabs/affordance_diffusion)
- `NeurIPS'22` :mag_right: Hand-Object Interaction Image Generation [[project]](https://play-with-hoi-generation.github.io/) [[code]](https://github.com/play-with-HOI-generation/HOIG)

### Whole-body Interaction
- `arxiv` GraspDiffusion: Synthesizing Realistic Whole-body Hand-Object Interaction [[paper]](https://arxiv.org/abs/2410.13911)
- `ECCV'24` HumanRefiner: Benchmarking Abnormal Human Generation and Refining with Coarse-to-fine Pose-Reversible Guidance [[code-unavailable]](https://github.com/Enderfga/HumanRefiner)
- `ACMMM'24` :mag_right: ReCorD: Reasoning and Correcting Diffusion for HOI Generation [[project]](https://alberthkyhky.github.io/ReCorD/) [[code]](https://github.com/j1anglin/ReCorD) 
- `ICME'24` :mag_right: Semantic-Aware Human Object Interaction Image Generation [[project]](https://sites.google.com/view/sa-hoi/) [[code]](https://github.com/XZPKU/SA-HOI)
...
- `CVPR'24` :mag_right: InteractDiffusion: Interaction-Control for Text-to-Image Diffusion Model [[project]](https://jiuntian.github.io/interactdiffusion/) [[code]](https://github.com/jiuntian/interactdiffusion)
- `CVPR'24` :mag_right: Person in Place: Generating Associative Skeleton-Guidance Maps for Human-Object Interaction Image Editing [[project]](https://yangchanghee.github.io/Person-in-Place_page/) [[code]](https://github.com/YangChangHee/CVPR2024_Person-In-Place_RELEASE)
- `CVPR'23` :mag_right: Putting People in Their Place: Affordance-Aware Human Insertion into Scenes [[project]](https://sumith1896.github.io/affordance-insertion/) [[code]](https://github.com/adobe-research/affordance-insertion)
